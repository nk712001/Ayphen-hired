    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center space-x-2 px-4 py-2 bg-card border border-border rounded-xl hover:bg-muted/50 hover:border-primary/20 transition-all duration-200 text-foreground min-w-[200px] justify-between shadow-sm"
            >
            ...
            {isOpen && (
                <>
                    ...
                    />
                    <div className="absolute top-full left-0 mt-2 w-72 bg-popover rounded-xl shadow-xl border border-border z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                ...
                                >
                                    <div className="flex items-center space-x-3 overflow-hidden">
                                        <div className={cn(
                                            ...
                                            currentOrg?.id === org.id ? "bg-primary/20 text-primary" : "bg-muted text-muted-foreground group-hover:bg-muted/80"
                                        )}>
                                            <Building2 className="h-4 w-4" />
                                        </div>
